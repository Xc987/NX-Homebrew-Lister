...
void clearselected(int selected) {
    if (selected == 1) {
        printf(CONSOLE_ESC(5;2H) CONSOLE_ESC(38;5;241m) "List aplications                                                              \n" CONSOLE_ESC(0m));
    } else if (selected == 2) {
        printf(CONSOLE_ESC(6;2H) CONSOLE_ESC(38;5;241m) "List overlays                                                                 \n" CONSOLE_ESC(0m));
    } else if (selected == 3) {
        printf(CONSOLE_ESC(7;2H) CONSOLE_ESC(38;5;241m) "List sysmodules                                                               \n" CONSOLE_ESC(0m));
    } else if (selected == 4) {
        printf(CONSOLE_ESC(8;2H) CONSOLE_ESC(38;5;241m) "List payloads                                                                 \n" CONSOLE_ESC(0m));
    } else if (selected == 5) {
        printf(CONSOLE_ESC(9;2H) CONSOLE_ESC(38;5;241m) "List exeFS patches                                                            \n" CONSOLE_ESC(0m));
    } else if (selected == 6) {
        printf(CONSOLE_ESC(10;2H) CONSOLE_ESC(38;5;241m) "List external game content                                                    \n" CONSOLE_ESC(0m));
    } else if (selected == 7) {
        printf(CONSOLE_ESC(12;2H) CONSOLE_ESC(38;5;241m) "Export all                                                                    \n" CONSOLE_ESC(0m));
    } else if (selected == 8) {
        printf(CONSOLE_ESC(14;2H) CONSOLE_ESC(38;5;241m) "Exit                                                                          \n" CONSOLE_ESC(0m));
    }
}
void drawselected(int selected) {
    if (selected == 1) {
        printf(CONSOLE_ESC(5;2H) CONSOLE_ESC(38;5;255m) CONSOLE_ESC(48;5;19m) "List aplications                                                              \n" CONSOLE_ESC(0m));
    } else if (selected == 2) {
        printf(CONSOLE_ESC(6;2H) CONSOLE_ESC(38;5;255m) CONSOLE_ESC(48;5;19m) "List overlays                                                                 \n" CONSOLE_ESC(0m));
    } else if (selected == 3) {
        printf(CONSOLE_ESC(7;2H) CONSOLE_ESC(38;5;255m) CONSOLE_ESC(48;5;19m) "List sysmodules                                                               \n" CONSOLE_ESC(0m));
    } else if (selected == 4) {
        printf(CONSOLE_ESC(8;2H) CONSOLE_ESC(38;5;255m) CONSOLE_ESC(48;5;19m) "List payloads                                                                 \n" CONSOLE_ESC(0m));
    } else if (selected == 5) {
        printf(CONSOLE_ESC(9;2H) CONSOLE_ESC(38;5;255m) CONSOLE_ESC(48;5;19m) "List exeFS patches                                                            \n" CONSOLE_ESC(0m));
    } else if (selected == 6) {
        printf(CONSOLE_ESC(10;2H) CONSOLE_ESC(38;5;255m) CONSOLE_ESC(48;5;19m) "List external game content                                                    \n" CONSOLE_ESC(0m));
    } else if (selected == 7) {
        printf(CONSOLE_ESC(12;2H) CONSOLE_ESC(38;5;255m) CONSOLE_ESC(48;5;19m) "Export all                                                                    \n" CONSOLE_ESC(0m));
    } else if (selected == 8) {
        printf(CONSOLE_ESC(14;2H) CONSOLE_ESC(38;5;255m) CONSOLE_ESC(48;5;19m) "Exit                                                                          \n" CONSOLE_ESC(0m));
    }
}
void updateDetails() {
